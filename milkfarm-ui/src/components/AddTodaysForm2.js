        ...
        <div className='row d-flex justify-content-center '>
            ...
            <div className='p-5 col mx-auto'>
                ...
                <div className="row mb-3 align-content-center"  >
                    <label htmlFor="inputName" className="col-sm-2 col-form-label fs-4">Name :</label>
                ...
                <div className="row mb-3 align-content-center"  >
                    <label htmlFor="inputName" className="col-sm-2 col-form-label fs-4">FAT :</label>
                    <div className="col-sm-6">
                        <input type="number" className="form-control fs-4 " onChange={(e) => handle(e)} id="fat" value={data.fat} />
                    </div>
                </div>
                <div className="row mb-3 align-content-center"  >
                    <label htmlFor="inputName" className="col-sm-2 col-form-label fs-4">SNF </label>
                    <div className="col-sm-6">
                        <input type="number" className="form-control fs-4 " onChange={(e) => handle(e)} id="snf" value={data.snf} />
                    </div>
                </div>
                <div className="row mb-3 align-content-center"  >
                    <label htmlFor="inputName" className="col-sm-2 col-form-label fs-4">Rate </label>
                    <div className="col-sm-6">
                        <input type="number" className="form-control fs-4 " onChange={(e) => handle(e)} id="rate" value={data.rate} />
                    </div>
                </div>
                <div className="row mb-3 align-content-center"  >
                    <label htmlFor="inputName" className="col-sm-2 col-form-label fs-4">Liter of Milk</label>
                    <div className="col-sm-6">
